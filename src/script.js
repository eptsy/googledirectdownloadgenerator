...
function audiogenerate() {
  ...
  if (confirmALink == true) {
    ...
    document.getElementById(
      "copy-input-audio"
    ).value = `${audio1}${refinedALink}${audio2}`;
  } else {
    alert("Required Google Drive Share Link!");
  }
}
function videogenerate() {
  ...
  if (confirmVLink == true) {
    ...
    document.getElementById(
      "copy-input-video"
    ).value = `${video1}${refinedVLink}${video2}`;
  } else {
    alert("Required Google Drive Share Link!");
  }
}
...
function poplink() {
  ...
  document.getElementById("btn1").style.backgroundColor = "slateblue";
...
function popaudio() {
  ...
  document.getElementById("btn2").style.backgroundColor = "slateblue";
  document.getElementById("btn3").style.backgroundColor = "#F0F0F0";
...
function popvideo() {
  ...
  document.getElementById("btn1").style.backgroundColor = "#F0F0F0";
  document.getElementById("btn2").style.backgroundColor = "#F0F0F0";
  document.getElementById("btn3").style.backgroundColor = "slateblue";
